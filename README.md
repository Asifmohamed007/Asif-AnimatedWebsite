...
<div align="center">
  ...
  <h2 align="center">Asif - Animated Website</h2>
...
To run **Asif - Animated Website** locally, run this command on your git bash:

Linux and macOS:

```bash
sudo git clone https://github.com/Asifmohamed007/Asif-AnimatedWebsite.git
```

Windows:

```bash
git clone https://github.com/Asifmohamed007/Asif-AnimatedWebsite.git
```
